...
{ id: crypto.randomUUID(), name: "Ca intr-o povestire de Carver", img: "./Logo.png", desc: "Experiența paternității întâlnește noul ruralism într-un volum care înregistrează unele note mai reflexive și poate mai lirice decât ne-a obișnuit Mihai Duțescu până acum. ", genre: "Poetry" },
